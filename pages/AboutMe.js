        ...
        <Element id='about' name='about'>
            <Loader>
                <div className='w-3/4 mx-auto my-36 flex flex-col justify-center items-center'>
                    <p className='text-md uppercase text-brown-200 select-none'>values and passion</p>
                    <h1 className='text-brown-300 text-6xl font-bold text-center select-none'>About Me</h1>
                
                    <div className='w-full'>
                        {/* for medium and small screens*/}
                        <div className='w-1/2 mx-auto mt-14 mb-10 lg:hidden'>
                            <div className='mx-auto drop-shadow-xl'>
                                <Image src={profilePic} alt='profileImage' layout='responsive' className='rounded-full brightness-105' />
                            </div>
                        </div>
                        ...
                        <div className='flex justify-center items-center text-left'>
                            ...
                            <div className='w-1/4 mr-16 hidden lg:block drop-shadow-xl'>
                                <Image src={profilePic} alt='profileImage' layout='intrinsic' className='rounded-full hidden lg:block brightness-105'/>
                            </div>
                            <div className='flex flex-col lg:mt-28 lg:mb-20'>
                                <h1 className='mb-10 text-xl font-semibold'>
                                    Hey there! My name is <span className='text-white bg-brown-100'>&nbsp;Nicolle Gan&nbsp;</span> (yes, with double Ls!)
                                </h1>
                                <div className='text-left text-lg mb-5 flex-wrap sm:max-w-xl xl:max-w-2xl leading-loose'>
                                    <p>
                                        ...
                                        I hope to be able to use technology to create meaningful applications for the community and the world.
                                    </p>
                                    <p className='mt-6'>
                                        My current interests include cyber security and software testing.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='w-full h-auto mt-4 flex flex-col justify-center items-center'>
                            <h1 className='text-brown-300 text-xl font-bold text-center'>Technologies I have worked with</h1>
                        </div>
