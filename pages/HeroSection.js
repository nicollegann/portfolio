            ...
            <div className="flex">
              <div className="flex flex-col md:mt-7 lg:mt-16 justify-center">
                <h1 className="font-bold text-7xl text-left mb-10">
                  Hi, I&apos;m <span className="text-brown-300">Nicolle</span>
                </h1>
                ...
                <p className="text-left text-xl mb-10 flex-wrap leading-relaxed">
                  Hoping to create an impact on the community - and the world -
                  through technology.
                </p>
                <div className="flex justify-left">
                  <a
                    href="https://github.com/nicollegann"
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/nicolle-gan/"
                    target="_blank"
                    rel="noreferrer"
                  >
